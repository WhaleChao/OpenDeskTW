...
全能文件工作台的結合作品整體採 `AGPL-3.0-or-later`。完整 AGPL 條文位於同資料夾
...
- Tauri、Rust、npm、PyInstaller 與 Python 相依套件：維持各上游授權；精確版本與
  授權原文位於 `third-party/`。
- MAGI V2／V3：僅由本機協定連線，不包含 MAGI 程式本體。

官方原始碼：https://github.com/WhaleChao/OpenDeskTW

本程式不附帶任何擔保；詳情請見 AGPL 完整條文。
